      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        <Reveal className="max-w-3xl">
          ...
          <h2 className="mt-6 font-display text-display-lg text-ink">
            Two tracks. Both <span className="italic">in demand.</span> Both{" "}
            <span className="italic">backable.</span>
          </h2>
          <p className="mt-6 text-base leading-relaxed text-muted-foreground">
            We don't teach what's trendy. We teach what hires — high-growth, non-technical careers
            with a real ladder and real compensation.
          </p>
        </Reveal>
                ...
                <ol className="mt-4 space-y-2.5">
                  {t.weeks.map((w, i) => (
                    <li key={w} className="flex gap-4 text-sm text-foreground">
                      <span className="w-10 shrink-0 font-display text-base text-gold">
                        W{(i + 1) * 2 - 1}–{(i + 1) * 2}
                      </span>
